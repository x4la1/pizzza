...
class getStorefrontControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'StorefrontController.php';

        $container->services['App\\Controller\\StorefrontController'] = $instance = new \App\Controller\StorefrontController();
