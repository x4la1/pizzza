...
class __TwigTemplate_5522636bba93dc83d872cea4b03fbf99 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pizza"]) {
            // line 4
            yield "        <form action=\"/catalog/order\" class=\"product\" id=\"order";
...
{% block content %}
    {% for pizza in pizzas %}
        <form action=\"/catalog/order\" class=\"product\" id=\"order{{ pizza.pizza_id }}\" method=\"post\">
